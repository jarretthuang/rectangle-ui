...
@Component({
  ...
  imports: [NgClass],
  template: `
    <button type="button" [disabled]="disabled" [ngClass]="buttonClasses" (click)="toggle()">
...
export class SwitchComponent {
  ...
  protected get buttonClasses() {
    return [
      ...
      this.checked() ? "bg-primary-500" : "bg-primary-300 dark:bg-primary-700",
      this.disabled ? "opacity-60 cursor-not-allowed" : "cursor-pointer",
    ];
  }
  protected get thumbClasses() {
    return [
